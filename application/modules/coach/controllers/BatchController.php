<?php
class Coach_BatchController extends Zend_Controller_Action
{
	...
	public function indexAction()
	{
		...
		$rows = $this->BatchService->getAllDataByCoach($user->id_coach);
	...
	public function addAction()
	{
		...
		if ($this->getRequest()->isPost()) {
			...
			$this->_redirect('/coach/batch/edit/id/'.$id_batch);
		} else {
	...
	public function editAction()
	{
		...
		if ($this->getRequest()->isPost()) {
			...
			$this->_redirect('/coach/batch/edit/id/'.$id);
	...
	// 			$path = "//172.16.30.157/www/mooc/mentoring";
	// 			$path_info = pathinfo($file_mentoring);
	// 			$file_mentoring = 'File-Forum-Diskusi'.'-'. uniqid() . '.' . $path_info['extension'];
	...
	// 				$this->SkorMentoringService->addSkor($id, $idpeserta, $id_mentor[$idx]);
	// 			}
	// 			// $this->SkorMentoringService->deleteSkor($id, $idpeserta, $id_mentor[$idx]);
	// 		}

	// 		$this->_redirect('/coach/batch/index');
	// 	}
	// 	$global = $this->PesertaBatchService->getAllDataBatch($id);
	// 	$this->view->mentoring = $this->MentoringService->getDataBatch($id);
	...
	{
		$id = $this->getRequest()->getParam('id');
		// $this->PesertaBatchService->softDeleteData($id);
