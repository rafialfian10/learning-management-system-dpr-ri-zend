<?php
class Coach_SertifikatController extends Zend_Controller_Action
{
	...
	public function editAction()
	{
		...
		if ($this->getRequest()->isPost()) {
			...
			$this->redirect('/coach/sertifikat/index');
	...
	public function deleteFilesAction() {
		...
		$this->_redirect('/coach/pengajar/edit/id/' . $id);
	}
	...
	public function deleteAction(){
		...
		$this->_redirect('/coach/pengajar/index');
	}
