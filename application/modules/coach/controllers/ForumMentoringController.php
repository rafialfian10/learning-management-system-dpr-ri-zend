<?php
class Coach_ForumMentoringController extends Zend_Controller_Action
{
	...
	public function indexAction()
	{
		...
		$coach_batchs = $this->PesertaBatchService->getAllDataCoach($auth->id_coach);
	...
	public function replyAction()
	{
		...
		if ($this->getRequest()->isPost()) {
			...
			// $this->_redirect('/coach/forum-mentoring/reply/id/'.$id);
			...
			$this->view->nama = $this->CoachService->getData($user->id_coach)->nama_coach;
			...
			$auth = Zend_Auth::getInstance()->getIdentity();
			$this->view->peserta_batch = $this->PesertaBatchService->getAllDataCoach($auth->id_coach);
