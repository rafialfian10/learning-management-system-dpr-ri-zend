<?php
class Pengajarnonasn_MateriSilabusController extends Zend_Controller_Action
{
		...
		if ($this->getRequest()->isPost()) {
			...
			if($file_size > 134217728){
				echo "<script>
						...
						$this->_redirect('/pengajarnonasn/materi-silabus/index');
					</script>";
			}
	...
	public function editAction() {
		...
		if ($this->getRequest()->isPost()) {
			...
			if ($file_size > 134217728) {
				echo "<script>
						alert('Ukuran gambar terlalu besar!');
						window.location.href='/pengajarnonasn/silabus/edit/id/".$id_silabus."';
					  </script>";
				return false;
			}
			...
			if($file_audio_size > 134217728){ 
				echo "<script>
						alert('Ukuran file audio terlalu besar!');
						$this->_redirect('/pengajarnonasn/silabus/edit/id/".$id_silabus."');
					</script>";
				return false; 
			}
			//----------------------------------------------
	...
	public function deletefilesAction() {
		...
		$this->_redirect('/pengajarnonasn/materi-silabus/edit/id/' . $id);
	}
