<?php
class Pengajarnonasn_NontesController extends Zend_Controller_Action {
...
// var_dump($id_nontes, $id_pelatihan, $title, $file_nontes);die();
	...
	public function deleteFilesAction() {
		...
		$this->_redirect('/pengajarnonasn/nontes/edit/id/' . $id_pelatihan);
	}
	...
	public function deleteAction() {
		...
		$this->_redirect('/pengajarnonasn/nontes/index');
	}
