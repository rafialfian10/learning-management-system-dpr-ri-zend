<?php
class Pengajar_NontesController extends Zend_Controller_Action {
	...
	public function addAction() {	
		...
		if ( $this->getRequest()->isPost() ) {
			...
			$this->_redirect('/pengajar/pelatihan/edit/id/'. $id_pelatihan);
		} else {
...
// var_dump($id_nontes, $id_pelatihan, $title, $file_nontes);die();
	...
	public function deleteFilesAction() {
		...
		$this->_redirect('/pengajar/nontes/edit/id/' . $id_pelatihan);
	}
	...
	public function deleteAction() {
		...
		$this->_redirect('/pengajar/nontes/index');
	}
