<?php
class Admin_NilaiMentoringController extends Zend_Controller_Action
{
	...
	public function addAction() {	
		if ($this->getRequest()->isPost()) {
			...
			$last_id= $this->SkorMentoringService->addData($id_batch, $id_peserta, $id_forum, $skor_keaktifan, $skor_pemahaman, $skor_tugas, $skor_forum, $skor_akhir);
		
			$this->_redirect('/admin/nilai-mentoring/edit/id/'.$last_id);
		}
	}
    ...
    public function editAction() {	
		...
		if ($this->getRequest()->isPost()) {
            ...
            $progress = $this->ProgressService->getProgress($id_peserta, $id_batch);
            $this->ProgressService->editData($progress->id, 'Penugasan');
			$last_id= $this->SkorMentoringService->editData($id, $id_batch, $id_peserta, $id_forum, $skor_keaktifan, $skor_pemahaman, $skor_tugas, $skor_forum, $skor_akhir);
		
			$this->_redirect('/admin/nilai-mentoring/edit/id/'.$id);
		} else {
    ...
    public function deleteAction() {
		...
		$this->_redirect('/admin/nilai-mentoring/index');
	}
