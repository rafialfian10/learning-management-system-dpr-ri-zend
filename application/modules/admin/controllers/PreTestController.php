<?php
class Admin_PreTestController extends Zend_Controller_Action {
	...
	public function addAction() {
		...
		if ($this->getRequest()->isPost()) {
			...
			if($file_size > 10000000){
				echo "<script>
						alert('Maks. 10MB');
						window.location.href='/admin/pretest/edit/id/".$id."';
					</script>";
				return false;
			}
	...
	public function deleteFilesAction() {
		$id = $this->getRequest()->getParam('id');
		$this->PreTestService->deleteFiles($id);
	...
	public function deletefilesnontesAction() {
		...
		$this->_redirect('/admin/pretest/edit/id/' . $id); 
	}
}