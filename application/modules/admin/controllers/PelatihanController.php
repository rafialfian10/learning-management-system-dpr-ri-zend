...
class Admin_PelatihanController extends Zend_Controller_Action {
	...
	public function deleteAction() {
		...
		$this->PreTestService->softDeleteDataPelatihan($id);
		$this->SilabusService->softDeleteDataPelatihan($id);
		$this->MateriSilabusService->softDeleteDataPelatihan($id);
		$this->SilabusQuizService->softDeleteDataPelatihan($id);
		$this->NontesService->softDeleteDataPelatihan($id);
